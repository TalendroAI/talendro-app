  ...
  return (
    <section>
      ...
      <div className="max-w-6xl mx-auto py-16 px-4">
        <h2 className="text-4xl font-bold text-center mb-4">The Science Behind Talendro™</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 border-2 border-blue-100">
            ...
            <h3 className="text-2xl font-bold mb-4">Apply First, Win More</h3>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 border-2 border-green-100">
            <div className="text-5xl mb-4">🎯</div>
            <h3 className="text-2xl font-bold mb-4">Tailored Resumes Win</h3>
            <p className="text-sm text-gray-700 mb-4">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 border-2 border-purple-100">
            <div className="text-5xl mb-4">📊</div>
            <h3 className="text-2xl font-bold mb-4">Timing Is Everything</h3>
            <p className="text-sm text-gray-700 mb-4">
        ...
        <div className="bg-red-50 rounded-xl p-8 border-2 border-red-200 mb-8">
          <h3 className="text-2xl font-bold mb-4 text-center">The Problem: You Can't Be Fast Enough Manually</h3>
        ...
        <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl p-8 border-2 border-talBlue">
          <h3 className="text-2xl font-bold mb-4 text-center">The Talendro™ Solution: Autonomous Speed + Perfect Tailoring</h3>
      ...
      <div className='mt-8 flex flex-wrap gap-3'>
        ...
        <a href='/services/navigator'><button className='btn btn-secondary mr-3'>Learn More</button></a>
      </div>
