        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="body text-gray-700">Launch prep sessions anytime from your dashboard. Review feedback, talking points, and improvement areas before every interview.</p>
            </div>
          </div>
        </div>
      </section>
