          ...
          <table className="w-full text-sm border-collapse">
            ...
            <tbody>
              {[
                ...
                ['Email notifications', '✓', '✓', '✓'],
                ['Interview coaching', 'AI Quick Prep report', 'AI Full Mock (chat)', 'AI Live Voice Mock (spoken)'],
                ['Salary negotiation', '—', 'AI Full Mock role-play (chat)', 'AI Live Voice role-play (spoken)'],
