      ...
      <div className="mt-6">
        ...
        <div className="space-y-8">
          <div className="card">
            ...
            <p className="body mb-4">After two decades in recruitment leadership, our founder witnessed a troubling pattern: qualified candidates across the entire US workforce were struggling with job searches. The problem wasn't limited to any single industry, occupation, or pay grade. Everyone was spending months in a process that should have taken weeks.</p>
          ...
          <div className="card">
            ...
            <p className="body mb-4">K. Greg Jackson brings over 20 years of recruitment leadership experience, having placed thousands of workers in roles across every industry, occupation type, and pay grade — from technology to healthcare to government to skilled trades. As both a veteran and an AI Blackbelt, Greg understands the challenges faced by workers throughout the entire US workforce.</p>
          ...
          <div className="card">
            ...
            <p className="body mb-4">We envision a world where career advancement is based on merit and capability, not on who has the most time to spend on job applications. Where every worker — in every field, at every level, doing every kind of work — can compete on equal footing for the opportunities they deserve.</p>
