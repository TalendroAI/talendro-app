...
const InterviewCoachLanding = () => {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="pb-16 px-4" style={{ paddingTop: '0' }}>
        <div className="max-w-6xl mx-auto bg-gray-50 px-8" style={{ maxWidth: '1200px', paddingTop: '24px', paddingBottom: '48px', marginTop: '0' }}>
          <h1
            className="h1 mb-4"
            style={{ fontSize: '2.5rem', lineHeight: '1.1', marginTop: '0' }}
          >
      ...
      <section className="py-4 px-4">
        <div className="max-w-6xl mx-auto bg-talBlue text-center px-8 py-4" style={{ maxWidth: '1200px' }}>
      ...
      <section className="py-16 bg-white px-4">
        <div className="max-w-4xl mx-auto" style={{ maxWidth: '1200px' }}>
      ...
      <footer className="py-8 px-4" style={{ backgroundColor: 'transparent' }}>
        <div className="max-w-6xl mx-auto bg-gray-900 text-white text-center px-8 py-8" style={{ maxWidth: '1200px' }}>
