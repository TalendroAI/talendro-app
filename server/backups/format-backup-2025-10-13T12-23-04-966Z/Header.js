    ...
    <header className="border-b border-gray-200">
      <div className="container flex items-center justify-between py-4">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <Link to={isOnWelcomePage ? "/app/onboarding/step-2" : isOnUploadResumePage ? "/app/onboarding/step-1" : isOnCreateProfilePage ? "/app/onboarding/step-3" : isOnPersonalInfoPage ? "/app/onboarding/step-4" : isOnProfessionalInfoPage ? "/app/onboarding/step-5" : isOnDisclosuresPage ? "/app/checkout" : isOnReviewPage ? "/app/dashboard" : "/app/onboarding/welcome"}>
      ...
      {open && (
        <div className="md:hidden border-t border-gray-200">
          <div className="container py-4 flex flex-col gap-3">
            ...
            <Link to="/contact">Contact</Link>
            <Link to="/auth/sign-in" className="text-talBlue hover:underline">Sign In</Link>
            <Link to={isOnWelcomePage ? "/app/onboarding/step-2" : isOnUploadResumePage ? "/app/onboarding/step-1" : isOnCreateProfilePage ? "/app/onboarding/step-3" : isOnPersonalInfoPage ? "/app/onboarding/step-4" : "/app/onboarding/welcome"}>
              <Button className="mt-2">{isOnWelcomePage ? "Upload Resume" : isOnUploadResumePage ? "Create Profile" : isOnCreateProfilePage ? "Personal Information" : isOnPersonalInfoPage ? "Residential History" : "Get Started"}</Button>
            </Link>
          </div>
        </div>
      )}
