...
export default function Header(){
  ...
  const handleCreateProfileClick = () => {
    if (isOnUploadResumePage) {
      // Check if resume has been uploaded by looking for resumeData in localStorage
    ...
    // If resume is uploaded or not on upload page, proceed with normal navigation
    return true
  }
      ...
      <div className="container flex items-center justify-between py-4">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          {isOnUploadResumePage ? (
            ...
            <Link to={isOnWelcomePage ? "/app/onboarding/step-1" : isOnCreateProfilePage ? "/app/onboarding/step-3" : isOnPersonalInfoPage ? "/app/onboarding/step-4" : isOnProfessionalInfoPage ? "/app/onboarding/step-5" : isOnDisclosuresPage ? "/app/checkout" : isOnReviewPage ? "/app/dashboard" : "/app/onboarding/welcome"}>
              <Button>{isOnWelcomePage ? "Upload Resume" : isOnCreateProfilePage ? "Personal Information" : isOnPersonalInfoPage ? "Professional Information" : isOnProfessionalInfoPage ? "Disclosures & Authorizations" : isOnDisclosuresPage ? "Proceed to Payment" : isOnReviewPage ? "Dashboard" : "Get Started"}</Button>
            </Link>
          )}
        </div>
        ...
        <div className="md:hidden border-t border-gray-200">
          <div className="container py-4 flex flex-col gap-3">
            ...
            {isOnUploadResumePage ? (
              ...
              <Link to={isOnWelcomePage ? "/app/onboarding/step-1" : isOnCreateProfilePage ? "/app/onboarding/step-3" : isOnPersonalInfoPage ? "/app/onboarding/step-4" : isOnProfessionalInfoPage ? "/app/onboarding/step-5" : isOnDisclosuresPage ? "/app/checkout" : isOnReviewPage ? "/app/dashboard" : "/app/onboarding/welcome"}>
                <Button className="mt-2">{isOnWelcomePage ? "Upload Resume" : isOnCreateProfilePage ? "Personal Information" : isOnPersonalInfoPage ? "Professional Information" : isOnProfessionalInfoPage ? "Disclosures & Authorizations" : isOnDisclosuresPage ? "Proceed to Payment" : isOnReviewPage ? "Dashboard" : "Get Started"}</Button>
              </Link>
            )}
          </div>
        </div>
          ...
          <div className="bg-white rounded-lg p-6 max-w-md mx-4 shadow-lg">
            ...
            <div className="mb-4">
              <p className="text-sm text-red-600">
                You must upload your resume before proceeding to create your profile. Please select a resume file and try again.
              </p>
            </div>
