        ...
        <div className="grid md:grid-cols-2 gap-6 mt-6">
          <div className="card">
            ...
            <input 
              ...
              className={`w-full border rounded-xl h-11 px-3 focus:outline-none focus:ring-2 focus:ring-talAqua ${
                errors.firstName ? 'border-red-500 bg-red-50 ring-2 ring-red-200' : 'border-talGray'
              }`}
              placeholder="John"
            ...
            <input 
              type="text"
              className={`w-full border rounded-xl h-11 px-3 focus:outline-none focus:ring-2 focus:ring-talAqua ${
                errors.lastName ? 'border-red-500 bg-red-50 ring-2 ring-red-200' : 'border-talGray'
              }`}
              placeholder="Doe"
            ...
            <input 
              type="email"
              className={`w-full border rounded-xl h-11 px-3 focus:outline-none focus:ring-2 focus:ring-talAqua ${
                errors.email ? 'border-red-500 bg-red-50 ring-2 ring-red-200' : 'border-talGray'
              }`}
          ...
          <div className="card">
            ...
            <input 
              type="tel"
              className={`w-full border rounded-xl h-11 px-3 focus:outline-none focus:ring-2 focus:ring-talAqua ${
                errors.phone ? 'border-red-500 bg-red-50 ring-2 ring-red-200' : 'border-talGray'
              }`}
            ...
            <input 
              type="password"
              className={`w-full border rounded-xl h-11 px-3 focus:outline-none focus:ring-2 focus:ring-talAqua ${
                errors.password ? 'border-red-500 bg-red-50 ring-2 ring-red-200' : 'border-talGray'
              }`}
            ...
            <input 
              type="password"
              className={`w-full border rounded-xl h-11 px-3 focus:outline-none focus:ring-2 focus:ring-talAqua ${
                errors.confirmPassword ? 'border-red-500 bg-red-50 ring-2 ring-red-200' : 'border-talGray'
              }`}
            ...
            <div className="flex items-center h-5">
              <input
                ...
                className={`w-4 h-4 text-talAqua bg-gray-100 border-gray-300 rounded focus:ring-talAqua focus:ring-2 ${
                  errors.agreeToTerms ? 'border-red-500 bg-red-50 ring-2 ring-red-200' : ''
                }`}
