...
export default function FormRendererComprehensive({ schema, resumeData, initialData = {}, onSubmit }) {
  ...
  useEffect(() => {
    ...
    const fieldsToForce = ['workArrangement', 'protectedVeteran', 'race', 'profileReview', 'talendroAuthorization', 'streetAddress', 'postalCode', 'county', 'city']
    ...
    fieldsToForce.forEach(fieldKey => {
      ...
      } else if (fieldKey === 'streetAddress' || fieldKey === 'postalCode' || fieldKey === 'county' || fieldKey === 'city') {
    ...
    const revalidateFields = () => {
      ...
      allFields.forEach(field => {
        ...
        if (fieldName === 'workArrangement' || fieldName === 'protectedVeteran' || fieldName === 'race' || 
            fieldName === 'streetAddress' || fieldName === 'postalCode' || fieldName === 'county' || fieldName === 'city') {
