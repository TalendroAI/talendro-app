...
import { generateBooleanSearchString, validateBooleanString } from '../../utils/booleanSearchGenerator';
...
const Onb4 = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const searchString = await generateBooleanSearchString(profileData);
      
      // 4. Validate the search string
      const validation = validateBooleanString(searchString);
      if (!validation.valid) {
        throw new Error(validation.error);
      }
      
      // 5. Store the search string
      localStorage.setItem('booleanSearchString', JSON.stringify(searchString));
      
      console.log('✓ Boolean Search String Generated:', searchString);
      ...
      alert('We encountered an issue analyzing your profile. Please try again. If the problem persists, you can continue and we\'ll generate your search profile after signup.');
