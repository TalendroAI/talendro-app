...
export default function Onb3() {
  ...
  useEffect(() => {
    try {
      ...
      // NUCLEAR OPTION: Force clear ALL education data
      if (combinedData.prefill?.step3) {
        combinedData.prefill.step3.majorFieldOfStudy = ''
        combinedData.prefill.step3.highestDegree = ''
        combinedData.prefill.step3.gpa = ''
        combinedData.prefill.step3.institutionName = ''
        combinedData.prefill.step3.institutionAddress = ''
        combinedData.prefill.step3.institutionCity = ''
        combinedData.prefill.step3.institutionState = ''
        combinedData.prefill.step3.attendanceStartDate = ''
        combinedData.prefill.step3.graduationDate = ''
        combinedData.prefill.step3.country = 'US'
        console.log('🔍 Onb3 - NUCLEAR OPTION: Cleared ALL education data')
      }
      
      // Also clear any direct education data
      combinedData.majorFieldOfStudy = ''
      combinedData.highestDegree = ''
      combinedData.gpa = ''
      combinedData.institutionName = ''
      combinedData.institutionAddress = ''
      combinedData.institutionCity = ''
      combinedData.institutionState = ''
      combinedData.attendanceStartDate = ''
      combinedData.graduationDate = ''
      combinedData.country = 'US'
      console.log('🔍 Onb3 - NUCLEAR OPTION: Cleared direct education data')
