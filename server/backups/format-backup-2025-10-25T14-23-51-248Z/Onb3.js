          ...
          <div className="bg-white rounded-lg p-6 max-w-md mx-4 shadow-lg">
            ...
            <div className="mb-4">
              <p className="text-sm" style={{color: '#dc2626'}}>
                You must complete all required fields (marked with red highlighting) before proceeding to Professional Information. Please fill out the missing information and try again.
              </p>
            </div>
