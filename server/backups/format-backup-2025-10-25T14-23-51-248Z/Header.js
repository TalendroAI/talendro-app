...
export default function Header(){
  ...
  const handleProfessionalInfoClick = () => {
    ...
    // If all fields are completed or not on personal info page, proceed with normal navigation
    return true
  }
  ...
  const handleDisclosuresClick = () => {
    ...
    // If all fields are completed or not on professional info page, proceed with normal navigation
    return true
  }
  ...
  const handlePaymentClick = () => {
    ...
    // If all fields are completed or not on disclosures page, proceed with normal navigation
    return true
  }
      ...
      <div className="container flex items-center justify-between py-4">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          {isOnUploadResumePage ? (
            ...
            <Link to={isOnWelcomePage ? "/app/onboarding/step-1" : isOnCreateProfilePage ? "/app/onboarding/step-3" : isOnReviewPage ? "/app/dashboard" : "/app/onboarding/welcome"}>
              <Button>{isOnWelcomePage ? "Upload Resume" : isOnCreateProfilePage ? "Personal Information" : isOnReviewPage ? "Dashboard" : "Get Started"}</Button>
            </Link>
          )}
        </div>
        ...
        <div className="md:hidden border-t border-gray-200">
          <div className="container py-4 flex flex-col gap-3">
            ...
            {isOnUploadResumePage ? (
              ...
              <Link to={isOnWelcomePage ? "/app/onboarding/step-1" : isOnCreateProfilePage ? "/app/onboarding/step-3" : isOnReviewPage ? "/app/dashboard" : "/app/onboarding/welcome"}>
                <Button className="mt-2">{isOnWelcomePage ? "Upload Resume" : isOnCreateProfilePage ? "Personal Information" : isOnReviewPage ? "Dashboard" : "Get Started"}</Button>
              </Link>
            )}
          </div>
        </div>
            ...
            <div className="flex items-center mb-4">
              ...
              <div className="ml-3">
                <h3 className="text-lg font-medium text-gray-900">
                  {isOnUploadResumePage ? "Resume Required" : "Complete Required Information"}
                </h3>
              </div>
            </div>
            <div className="mb-4">
