        ...
        <div className="grid md:grid-cols-2 gap-6 mt-6">
          <div className="card">
            ...
            <input 
              ...
              className={`w-full border rounded-xl h-11 px-3 focus:outline-none focus:ring-2 focus:ring-talAqua ${
                (errors.firstName || blankFields.has('firstName') || !String(formData.firstName).trim()) ? 'border-red-500 bg-red-50 ring-2 ring-red-200' : 'border-talGray'
              }`}
              style={(blankFields.has('firstName') || !String(formData.firstName).trim()) ? {borderColor: '#dc2626', backgroundColor: '#fef2f2', boxShadow: '0 0 0 3px #fecaca', borderWidth: '2px'} : {}}
              autoComplete="off"
              name="off-firstName"
            ...
            <input 
              type="text"
              className={`w-full border rounded-xl h-11 px-3 focus:outline-none focus:ring-2 focus:ring-talAqua ${
                (errors.lastName || blankFields.has('lastName') || !String(formData.lastName).trim()) ? 'border-red-500 bg-red-50 ring-2 ring-red-200' : 'border-talGray'
              }`}
              style={(blankFields.has('lastName') || !String(formData.lastName).trim()) ? {borderColor: '#dc2626', backgroundColor: '#fef2f2', boxShadow: '0 0 0 3px #fecaca', borderWidth: '2px'} : {}}
              autoComplete="off"
              name="off-lastName"
            ...
            <input 
              type="email"
              className={`w-full border rounded-xl h-11 px-3 focus:outline-none focus:ring-2 focus:ring-talAqua ${
                (errors.email || blankFields.has('email') || !String(formData.email).trim()) ? 'border-red-500 bg-red-50 ring-2 ring-red-200' : 'border-talGray'
              }`}
              style={(blankFields.has('email') || !String(formData.email).trim()) ? {borderColor: '#dc2626', backgroundColor: '#fef2f2', boxShadow: '0 0 0 3px #fecaca', borderWidth: '2px'} : {}}
              autoComplete="off"
              name="off-email"
          ...
          <div className="card">
            ...
            <input 
              type="tel"
              className={`w-full border rounded-xl h-11 px-3 focus:outline-none focus:ring-2 focus:ring-talAqua ${
                (errors.phone || blankFields.has('phone') || !String(formData.phone).trim()) ? 'border-red-500 bg-red-50 ring-2 ring-red-200' : 'border-talGray'
              }`}
              style={(blankFields.has('phone') || !String(formData.phone).trim()) ? {borderColor: '#dc2626', backgroundColor: '#fef2f2', boxShadow: '0 0 0 3px #fecaca', borderWidth: '2px'} : {}}
              autoComplete="off"
              name="off-phone"
            ...
            <div className="flex gap-2">
              <input 
                ...
                className={`flex-1 border rounded-xl h-11 px-3 focus:outline-none focus:ring-2 focus:ring-talAqua ${
                  (errors.password || blankFields.has('password') || !String(formData.password).trim()) ? 'border-red-500 bg-red-50 ring-2 ring-red-200' : 'border-talGray'
                }`}
                style={(blankFields.has('password') || !String(formData.password).trim()) ? {borderColor: '#dc2626', backgroundColor: '#fef2f2', boxShadow: '0 0 0 3px #fecaca', borderWidth: '2px'} : {}}
            ...
            <input 
              type="password"
              className={`w-full border rounded-xl h-11 px-3 focus:outline-none focus:ring-2 focus:ring-talAqua ${
                (errors.confirmPassword || blankFields.has('confirmPassword') || !String(formData.confirmPassword).trim()) ? 'border-red-500 bg-red-50 ring-2 ring-red-200' : 'border-talGray'
              }`}
              style={(blankFields.has('confirmPassword') || !String(formData.confirmPassword).trim()) ? {borderColor: '#dc2626', backgroundColor: '#fef2f2', boxShadow: '0 0 0 3px #fecaca', borderWidth: '2px'} : {}}
            ...
            <div className="flex items-center h-5">
              <input
                ...
                className={`w-4 h-4 text-talAqua bg-gray-100 border-gray-300 rounded focus:ring-talAqua focus:ring-2 ${
                  (errors.agreeToTerms || blankFields.has('agreeToTerms') || !formData.agreeToTerms) ? 'border-red-500 bg-red-50 ring-2 ring-red-200' : ''
                }`}
                style={(blankFields.has('agreeToTerms') || !formData.agreeToTerms) ? {borderColor: '#dc2626', backgroundColor: '#fef2f2', boxShadow: '0 0 0 4px #fecaca', borderWidth: '3px', outline: '2px solid #dc2626'} : {}}
