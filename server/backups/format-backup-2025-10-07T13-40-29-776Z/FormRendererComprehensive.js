...
export default function FormRendererComprehensive({ schema, resumeData, initialData = {}, onSubmit }) {
  ...
  useEffect(() => {
    ...
    fields.forEach(field => {
      ...
      // ENHANCED: Try step3Data first with proper value extraction
      if (step3Data[fieldKey] !== undefined && step3Data[fieldKey] !== null && step3Data[fieldKey] !== '') {
        // Extract value from confidence-scored objects
        const rawValue = step3Data[fieldKey]
        ...
        // Only use if value is non-empty after extraction
      ...
      if (educationFields.includes(fieldKey) &&
