...
export default function Header(){
  ...
  const handlePaymentClick = () => {
    ...
    // If all fields are completed or not on disclosures page, proceed to review page
    window.location.href = '/app/onboarding/review'
  }
      ...
      <div className="container flex items-center justify-between py-4">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          {isOnUploadResumePage ? (
            ...
            <Button onClick={handlePaymentClick}>Review and Approve</Button>
          ) : (
        ...
        <div className="md:hidden border-t border-gray-200">
          <div className="container py-4 flex flex-col gap-3">
            ...
            {isOnUploadResumePage ? (
              ...
              <Button className="mt-2" onClick={handlePaymentClick}>Review and Approve</Button>
            ) : (
              isOnCreateProfilePage ? (
